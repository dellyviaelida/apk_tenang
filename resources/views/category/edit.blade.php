        ...
        <div class="row">
            <div class="col-8">
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="nama-kategori" placeholder="Masukkan Judul" required value="{{ old('name', $category->name) }}">
                    @error('name')
